    ...
    card_scale cs) -> std::ostream &
{
    switch (cs)
    {
    case card_scale::two:os << '2'; break;
    case card_scale::three:os << '3';break;
    case card_scale::four:os << '4';break;
    case card_scale::five:os << '5';break;
    case card_scale::six:os << '6';break;
    case card_scale::seven:os << '7';break;
    case card_scale::eight:os << '8';break;
    case card_scale::nine:os << '9';break;
    case card_scale::ten:os << 'T';break;
    case card_scale::ace:os << 'A';break;
    }
    return os;
}
...
struct cards
{
    ...
    constexpr cards(std::initializer_list<card_scale> list)
        : store_{}
    {
        for (auto c : list)
            ++store_[to_index(c)];
    ...
    template<class...CardScale,
        std::enable_if_t<
            (std::is_same_v<CardScale, card_scale> && ...)> * = nullptr>
    constexpr
    cards(CardScale...cs)
        : store_{}
    {
    ...
    void add(card_scale cs, std::size_t n = 1)
    {

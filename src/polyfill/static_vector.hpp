...
struct static_vector
{
    ...
    template<class U = T, std::enable_if_t<std::is_copy_constructible_v<U>> * = nullptr>
    ...
    template<class U = T, std::enable_if_t<std::is_copy_constructible_v<U>> * = nullptr>
    static_vector &
    operator=(static_vector const &other)
    {
        auto tmp = other;
        *this = std::move(other);
    }

    template<class U = T, std::enable_if_t<std::is_move_constructible_v<U>> * = nullptr>
...
private:
    ...
    get() -> T *
    {
        return std::addressof(reinterpret_cast<T &>(store_));
    };
